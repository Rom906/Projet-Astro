from generate_solutions import (
    ...
    saved_plot_kinetic_energy,
    saved_plot_2d_projections,
)
...
def compute_solution_specific(
    initial_conditions: Vector,
    parameters: NormalizationParameters,
    save_name_KE: str,
    save_name_phase: str,
    save_name_position: str,
    save_name_velocity: str,
    save_name_time_intervall: str,
):
    ...
    for i in range(len(solution_normalized)):
        position_denormalized, velocity_denormalized = (
    ...
    for i in range(4):
        ...
        initial_conditions.append(
            (
                initial_condition,
                parameters,
                f"save_KE_{i}_{x_start}_{y_start}_{z_start}_{vx_start}_{vy_start}_{vz_start}.png",
                f"save_phase_{i}_{x_start}_{y_start}_{z_start}_{vx_start}_{vy_start}_{vz_start}.png",
                f"save_position_{i}_{x_start}_{y_start}_{z_start}_{vx_start}_{vy_start}_{vz_start}.csv",
                f"save_time_{i}_{x_start}_{y_start}_{z_start}_{vx_start}_{vy_start}_{vz_start}.csv",
                f"save_KE_{i}_{x_start}_{y_start}_{z_start}_{vx_start}_{vy_start}_{vz_start}.csv",
            )
        )
