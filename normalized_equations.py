...
def B_normalized(R_norm, mu_norm, R0_norm=np.array([0., 0., 0.]), mu0_norm=1.0):
    """
...
def differential_equation_normalized(t_norm: float, Y: Vector, params: NormalizationParameters) -> Vector:
    """
    ...
    B_field = B_normalized(R_array, np.array([0., 0., 1.]))  # Normalized dipole along z
